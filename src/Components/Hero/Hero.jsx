    ...
    return (
        <section className='hero w-100 pt-4 px-0 p-lg-4'>
            <div className='background-hero rounded-start-5 rounded-top-5 position-relative row justify-content-center w-auto h-100 align-items-center flex-row-reverse'>
                <div className='hero-img-div bg-main-blue right-hero-div-bg col-12 col-lg-6 d-flex justify-content-center'>
                    <img className='img-fluid h-100' src="src/assets/imgs/heroThumb1_1.webp" alt="" />
                </div>
                <div className='hero-text-div bg-main-blue  left-hero-div-bg col-12 col-lg-6 d-flex flex-column gap-2 justify-content-center align-items-center'>
                    <div className='w-75' >
